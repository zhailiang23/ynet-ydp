...
export function useFormSchema(): VbenFormSchema[] {
  return [
    ...
    },
    {
      ...
      label: '评级方式（字典: aicrm_rating_method）',
      component: 'Input',
      componentProps: {
        placeholder: '请输入评级方式（字典: aicrm_rating_method）',
      },
    },
    {
    ...
    },
    {
      ...
      label: '调整类型（字典: aicrm_rating_change_type，upgrade=升级，downgrade=降级，maintain=维持）',
      component: 'Select',
      componentProps: {
        options: [],
        placeholder: '请选择调整类型（字典: aicrm_rating_change_type，upgrade=升级，downgrade=降级，maintain=维持）',
      },
    },
    {
      fieldName: 'previousValueLevel',
      label: '调整前价值等级',
      component: 'Input',
      componentProps: {
        placeholder: '请输入调整前价值等级',
      },
    },
    {
      fieldName: 'previousServiceLevel',
      label: '调整前服务等级',
      component: 'Input',
      componentProps: {
        placeholder: '请输入调整前服务等级',
      },
    },
    {
      fieldName: 'remark',
...
/** 列表的字段 */
export function useGridColumns(): VxeTableGridOptions<AicrmCustomerRatingHistoryApi.CustomerRatingHistory>['columns'] {
  return [
  { type: 'checkbox', width: 40 },
    ...
    {
      field: 'ratingMethod',
      title: '评级方式（字典: aicrm_rating_method）',
      minWidth: 120,
    },
    {
      field: 'custGradeId',
    ...
    {
      field: 'changeType',
      title: '调整类型（字典: aicrm_rating_change_type，upgrade=升级，downgrade=降级，maintain=维持）',
      minWidth: 120,
    },
    {
      field: 'previousValueLevel',
      title: '调整前价值等级',
      minWidth: 120,
    },
    {
      field: 'previousServiceLevel',
      title: '调整前服务等级',
      minWidth: 120,
    },
    {
