...
export function useFormSchema(): VbenFormSchema[] {
  return [
    ...
    {
      fieldName: 'groupId',
      label: '客群ID（关联 crm_customer_group_info.id）',
      rules: 'required',
      component: 'Input',
      componentProps: {
        placeholder: '请输入客群ID（关联 crm_customer_group_info.id）',
      },
    },
    {
...
/** 列表的字段 */
export function useGridColumns(): VxeTableGridOptions<AicrmCustomerGroupAssignmentApi.CustomerGroupAssignment>['columns'] {
  return [
  { type: 'checkbox', width: 40 },
    ...
    {
      field: 'groupId',
      title: '客群ID（关联 crm_customer_group_info.id）',
      minWidth: 120,
    },
    {
      field: 'assignDate',
