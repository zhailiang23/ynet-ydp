...
import { message, Upload, Modal as AntModal, Input, Card, Tag, Empty } from 'ant-design-vue';
...
const baseName = computed(() => baseData.value?.name);
...
<template>
  <Modal
    class="!w-[1200px] !max-w-[90vw] !h-[80vh]"
    :body-class="'!p-3 !pb-0'"
    :footer-class="'!pt-0'"
    title="文件管理"
    :closable="true"
    ...
    <div class="flex flex-col h-full">
      <div class="mb-4 flex items-center justify-between">
        ...
        <div class="flex gap-2">
          ...
          <a-button @click="handleOpenRetrieveModal">
            <SearchOutlined />
            召回测试
          </a-button>
          <a-button
