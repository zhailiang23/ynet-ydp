...
// 有效期：30分钟（毫秒）
const REL_ID_EXPIRY_TIME = 1 * 60 * 1000;
...
const setIframeSrc = () => {
  // 支持本地和测试环境
  const localBaseUrl = 
    'http://localhost:3000/shareDashboard/cc3785bf6e8f4e12b9b96578c7c47f95?type=NONE'; // 'http://localhost:3000/organizations/127d315a9e1f499590edc151db7ba353/vizs/7e5b7443bcb342bf976ffb3ec7a163fd';
  ...
  if (storedRelId && storedExpireTime && Number.parseInt(storedExpireTime) > currentTime) {
  ...
  src.value = `${baseUrl}?${params.toString()}`;
};
