package com.ynet.iplatform.framework.jackson.config;

import com.ynet.iplatform.framework.common.util.json.JsonUtils;
import com.ynet.iplatform.framework.common.util.json.databind.LocalDateStringDeserializer;
import com.ynet.iplatform.framework.common.util.json.databind.LocalDateStringSerializer;
import com.ynet.iplatform.framework.common.util.json.databind.NumberSerializer;
import com.ynet.iplatform.framework.common.util.json.databind.TimestampLocalDateTimeDeserializer;
import com.ynet.iplatform.framework.common.util.json.databind.TimestampLocalDateTimeSerializer;
...
@Slf4j
public class IplatformJacksonAutoConfiguration {
