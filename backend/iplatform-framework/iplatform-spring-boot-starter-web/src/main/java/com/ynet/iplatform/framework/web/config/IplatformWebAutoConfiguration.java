package com.ynet.iplatform.framework.web.config;
...
import com.ynet.iplatform.framework.web.core.filter.CacheRequestBodyFilter;
import com.ynet.iplatform.framework.web.core.filter.DemoFilter;
import com.ynet.iplatform.framework.web.core.handler.GlobalExceptionHandler;
import com.ynet.iplatform.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class IplatformWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "iplatform.demo", havingValue = "true")
