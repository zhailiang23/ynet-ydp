package com.ynet.iplatform.framework.desensitize.core;

import com.ynet.iplatform.framework.common.util.json.JsonUtils;
import com.ynet.iplatform.framework.desensitize.core.annotation.Address;
import com.ynet.iplatform.framework.desensitize.core.regex.annotation.EmailDesensitize;
import com.ynet.iplatform.framework.desensitize.core.regex.annotation.RegexDesensitize;
import com.ynet.iplatform.framework.desensitize.core.slider.annotation.*;
import lombok.Data;
...
public class DesensitizeTest {
    ...
    public void test() {
        ...
        desensitizeDemo.setNickname("易诚源码");
        ...
        desensitizeDemo.setRegex("你好，我是易诚源码");
        desensitizeDemo.setAddress("北京市海淀区上地十街10号");
        desensitizeDemo.setOrigin("易诚源码");
    ...
    public static class DesensitizeDemo {
        ...
        @RegexDesensitize(regex = "易诚源码", replacer = "*")
