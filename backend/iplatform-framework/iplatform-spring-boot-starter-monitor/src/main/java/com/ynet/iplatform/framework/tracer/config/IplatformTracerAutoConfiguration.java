package com.ynet.iplatform.framework.tracer.config;

import com.ynet.iplatform.framework.common.enums.WebFilterOrderEnum;
import com.ynet.iplatform.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "iplatform.tracer", value = "enable", matchIfMissing = true)
public class IplatformTracerAutoConfiguration {
