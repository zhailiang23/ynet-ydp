package cn.iocoder.yudao.module.aicrm.controller.admin.customerloanoverview.vo;
...
@Schema(description = "管理后台 - 客户贷款业务概览分页 Request VO")
@Data
public class CustomerLoanOverviewPageReqVO extends PageParam {

    @Schema(description = "客户ID", example = "31985")
