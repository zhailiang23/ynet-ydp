...
@Schema(description = "管理后台 - 客户工作或经营信息表分页 Request VO")
@Data
public class CustomerWorkPageReqVO extends PageParam {

    @Schema(description = "客户ID", example = "18589")
    private Long customerId;

    @Schema(description = "工作类型", example = "2")
    ...
    @Schema(description = "核验状态", example = "2")
