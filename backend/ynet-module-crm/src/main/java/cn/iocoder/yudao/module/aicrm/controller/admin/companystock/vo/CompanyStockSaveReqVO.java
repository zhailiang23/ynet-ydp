package cn.iocoder.yudao.module.aicrm.controller.admin.companystock.vo;
...
@Schema(description = "管理后台 - 对公客户股票发行人信息新增/修改 Request VO")
@Data
public class CompanyStockSaveReqVO {
    ...
    @NotEmpty(message = "上市交易所（上交所、深交所、港交所、纳斯达克、纽交所等）不能为空")
