...
@Schema(description = "管理后台 - 客户家庭信息表（零售客户）分页 Request VO")
@Data
public class CustomerFamilyPageReqVO extends PageParam {

    @Schema(description = "客户ID（关联零售客户，唯一）", example = "13691")
