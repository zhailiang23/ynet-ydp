package com.ynet.iplatform.module.aicrm.controller.admin.customeraccountloan.vo;
...
@Schema(description = "管理后台 - 客户贷款账户信息表（零售+对公共用）分页 Request VO")
@Data
public class CustomerAccountLoanPageReqVO extends PageParam {

    @Schema(description = "客户ID（关联 crm_customer 主表）", example = "6982")
    ...
    @Schema(description = "借款人姓名", example = "赵六")
    private String accountName;

    @Schema(description = "放款日期（开户日期）")
    ...
    @Schema(description = "账户状态（字典: aicrm_loan_account_status，normal=正常，overdue=逾期，settled=已结清，writeoff=核销）", example = "2")
    private String accountStatus;

    @Schema(description = "合同金额（授信额度）")
    private BigDecimal contractAmount;

    @Schema(description = "贷款金额（实际发放金额）")
