...
@Schema(description = "管理后台 - 对公客户他行信息分页 Request VO")
@Data
public class CompanyOtherBankPageReqVO extends PageParam {

    @Schema(description = "客户ID（关联crm_customer表）", example = "18661")
