package com.ynet.iplatform.module.aicrm.dal.dataobject.customerrating;
...
/**
 * 客户评级信息表（与客户主表1对1关系） DO
 *
 * @author 芋道源码
 */
@TableName("crm_customer_rating")
@KeySequence("crm_customer_rating_seq") // 用于 Oracle、PostgreSQL、Kingbase、DB2、H2 数据库的主键自增。如果是 MySQL 等数据库，可不写。
@Data
...
@NoArgsConstructor
@AllArgsConstructor
public class CustomerRatingDO extends BaseDO {
    ...
    /**
     * 评级方式（字典: aicrm_rating_method，system=系统评级，manual=人工评级）
     */
