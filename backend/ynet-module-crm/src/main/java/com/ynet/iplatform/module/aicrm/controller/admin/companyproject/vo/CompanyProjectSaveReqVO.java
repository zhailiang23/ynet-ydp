...
@Schema(description = "管理后台 - 对公客户项目信息新增/修改 Request VO")
@Data
public class CompanyProjectSaveReqVO {
    ...
    @NotEmpty(message = "项目类型（基建工程、房地产开发、技术改造、研发项目、并购重组、境外投资、产能扩张、环保治理等）不能为空")
