...
@Schema(description = "管理后台 - 客户评级信息表（与客户主表1对1关系）分页 Request VO")
@Data
public class CustomerRatingPageReqVO extends PageParam {

    @Schema(description = "客户ID（关联 crm_customer 主表，1对1关系）", example = "13431")
