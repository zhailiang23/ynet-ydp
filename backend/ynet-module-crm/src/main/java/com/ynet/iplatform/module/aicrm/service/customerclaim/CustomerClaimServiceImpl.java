...
import com.ynet.iplatform.module.aicrm.dal.mysql.customerclaim.CustomerClaimApplicationMapper;
...
public class CustomerClaimServiceImpl implements CustomerClaimService {
    ...
    @Resource
    private com.ynet.iplatform.module.aicrm.dal.mysql.customer.CustomerMapper customerMapper;
    ...
    public Long applyForClaim(Long userId, CustomerClaimApplicationApplyReqVO createReqVO) {
        ...
        // 4. 查询客户名称用于流程标题
        com.ynet.iplatform.module.aicrm.dal.dataobject.customer.CustomerDO customer =
    ...
    private void autoAssignCustomerAfterClaimApproved(Long applicationId) {
        ...
        // 2. 更新客户的分配状态为已分配
        com.ynet.iplatform.module.aicrm.dal.dataobject.customer.CustomerDO customer =
                new com.ynet.iplatform.module.aicrm.dal.dataobject.customer.CustomerDO();
