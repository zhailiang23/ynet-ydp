package com.ynet.iplatform.module.aicrm.controller.admin.customercontact.vo;
...
@Schema(description = "管理后台 - 客户接触信息分页 Request VO")
@Data
public class CustomerContactPageReqVO extends PageParam {

    @Schema(description = "客户ID（关联 crm_customer 主表）", example = "30695")
    ...
    @Schema(description = "接触类型（字典: aicrm_contact_type，customer_callback=客户反馈，phone=电话，visit=拜访，email=邮件，wechat=微信，meeting=会议等）", example = "2")
    private String contactType;

    @Schema(description = "客户经理")
    private String accountManager;

    @Schema(description = "接触目的")
    private String contactPurpose;

    @Schema(description = "接触反馈")
    ...
    @Schema(description = "接触编号")
    private String contactNo;

    @Schema(description = "接触状态（字典: aicrm_contact_status，planned=已计划，completed=已完成，cancelled=已取消）", example = "2")
    private String contactStatus;

    @Schema(description = "接触渠道（字典: aicrm_contact_channel，active=主动接触，passive=被动接触）")
