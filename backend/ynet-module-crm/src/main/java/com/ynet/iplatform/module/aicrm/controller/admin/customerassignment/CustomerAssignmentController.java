package com.ynet.iplatform.module.aicrm.controller.admin.customerassignment;
...
import com.ynet.iplatform.module.aicrm.service.customerassignment.CustomerAssignmentService;
...
public class CustomerAssignmentController {
    ...
    public CommonResult<Boolean> assignCustomers(@Valid @RequestBody AssignCustomerReqVO reqVO) {
        customerAssignmentService.assignCustomers(com.ynet.iplatform.framework.security.core.util.SecurityFrameworkUtils.getLoginUserId(), reqVO);
        return success(true);
    }
    ...
    public CommonResult<Boolean> reclaimCustomers(@Valid @RequestBody ReclaimCustomerReqVO reqVO) {
        customerAssignmentService.reclaimCustomers(com.ynet.iplatform.framework.security.core.util.SecurityFrameworkUtils.getLoginUserId(), reqVO);
        return success(true);
    }
    ...
    public CommonResult<Boolean> claimCustomers(@Valid @RequestBody ClaimCustomerReqVO reqVO) {
        Long userId = com.ynet.iplatform.framework.security.core.util.SecurityFrameworkUtils.getLoginUserId();
        // 获取当前用户的部门ID
