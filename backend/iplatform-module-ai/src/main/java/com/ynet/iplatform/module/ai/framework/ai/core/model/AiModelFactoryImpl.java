package com.ynet.iplatform.module.ai.framework.ai.core.model;
...
import com.ynet.iplatform.framework.common.util.spring.SpringUtils;
import com.ynet.iplatform.module.ai.enums.model.AiPlatformEnum;
import com.ynet.iplatform.module.ai.framework.ai.config.AiAutoConfiguration;
import com.ynet.iplatform.module.ai.framework.ai.config.IplatformAiProperties;
...
import com.ynet.iplatform.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageApi;
import com.ynet.iplatform.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageModel;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String apiKey, String url) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            IplatformAiProperties.Midjourney properties = SpringUtil.getBean(IplatformAiProperties.class)
                    .getMidjourney();
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#douBaoChatClient(IplatformAiProperties)}
     */
    private ChatModel buildDouBaoChatModel(String apiKey) {
        IplatformAiProperties.DouBao properties = new IplatformAiProperties.DouBao()
                .setApiKey(apiKey);
        return new AiAutoConfiguration().buildDouBaoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#hunYuanChatClient(IplatformAiProperties)}
     */
    private ChatModel buildHunYuanChatModel(String apiKey, String url) {
        IplatformAiProperties.HunYuan properties = new IplatformAiProperties.HunYuan()
                .setBaseUrl(url).setApiKey(apiKey);
        return new AiAutoConfiguration().buildHunYuanChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#siliconFlowChatClient(IplatformAiProperties)}
     */
    private ChatModel buildSiliconFlowChatModel(String apiKey) {
        IplatformAiProperties.SiliconFlow properties = new IplatformAiProperties.SiliconFlow()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#xingHuoChatClient(IplatformAiProperties)}
     */
    private static XingHuoChatModel buildXingHuoChatModel(String key) {
        ...
        IplatformAiProperties.XingHuo properties = new IplatformAiProperties.XingHuo()
                .setAppKey(keys.get(0)).setSecretKey(keys.get(1));
        return new AiAutoConfiguration().buildXingHuoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#baiChuanChatClient(IplatformAiProperties)}
     */
    private BaiChuanChatModel buildBaiChuanChatModel(String apiKey) {
        IplatformAiProperties.BaiChuan properties = new IplatformAiProperties.BaiChuan()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#buildGeminiChatClient(IplatformAiProperties.Gemini)}
     */
    private static GeminiChatModel buildGeminiChatModel(String apiKey) {
        IplatformAiProperties.Gemini properties = SpringUtil.getBean(IplatformAiProperties.class)
