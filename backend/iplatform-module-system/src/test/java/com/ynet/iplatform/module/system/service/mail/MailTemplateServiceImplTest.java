package com.ynet.iplatform.module.system.service.mail;
...
import com.ynet.iplatform.module.system.controller.admin.mail.vo.template.MailTemplateSaveReqVO;
import com.ynet.iplatform.module.system.controller.admin.mail.vo.template.MailTemplatePageReqVO;
import com.ynet.iplatform.module.system.dal.dataobject.mail.MailTemplateDO;
import com.ynet.iplatform.module.system.dal.mysql.mail.MailTemplateMapper;
...
import static com.ynet.iplatform.module.system.enums.ErrorCodeConstants.MAIL_TEMPLATE_NOT_EXISTS;
...
public class MailTemplateServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetMailTemplatePage() {
        ...
        // 测试 name 不匹配
        mailTemplateMapper.insert(cloneIgnoreId(dbMailTemplate, o -> o.setName("易诚")));
        // 测试 code 不匹配
