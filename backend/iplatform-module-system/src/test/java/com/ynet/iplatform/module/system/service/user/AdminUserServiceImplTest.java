package com.ynet.iplatform.module.system.service.user;
...
import com.ynet.iplatform.framework.common.util.collection.ArrayUtils;
import com.ynet.iplatform.framework.common.util.collection.CollectionUtils;
import com.ynet.iplatform.framework.test.core.ut.BaseDbUnitTest;
import com.ynet.iplatform.module.infra.api.config.ConfigApi;
import com.ynet.iplatform.module.infra.api.file.FileApi;
import com.ynet.iplatform.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import com.ynet.iplatform.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import com.ynet.iplatform.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import com.ynet.iplatform.module.system.controller.admin.user.vo.user.UserImportRespVO;
import com.ynet.iplatform.module.system.controller.admin.user.vo.user.UserPageReqVO;
import com.ynet.iplatform.module.system.controller.admin.user.vo.user.UserSaveReqVO;
import com.ynet.iplatform.module.system.dal.dataobject.dept.DeptDO;
import com.ynet.iplatform.module.system.dal.dataobject.dept.PostDO;
import com.ynet.iplatform.module.system.dal.dataobject.dept.UserPostDO;
import com.ynet.iplatform.module.system.dal.dataobject.tenant.TenantDO;
import com.ynet.iplatform.module.system.dal.dataobject.user.AdminUserDO;
import com.ynet.iplatform.module.system.dal.mysql.dept.UserPostMapper;
import com.ynet.iplatform.module.system.dal.mysql.user.AdminUserMapper;
import com.ynet.iplatform.module.system.enums.common.SexEnum;
import com.ynet.iplatform.module.system.service.dept.DeptService;
import com.ynet.iplatform.module.system.service.dept.PostService;
import com.ynet.iplatform.module.system.service.permission.PermissionService;
...
import static com.ynet.iplatform.framework.common.util.collection.SetUtils.asSet;
import static com.ynet.iplatform.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static com.ynet.iplatform.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static com.ynet.iplatform.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static com.ynet.iplatform.framework.test.core.util.AssertUtils.assertPojoEquals;
import static com.ynet.iplatform.framework.test.core.util.AssertUtils.assertServiceException;
import static com.ynet.iplatform.framework.test.core.util.RandomUtils.*;
import static com.ynet.iplatform.module.system.enums.ErrorCodeConstants.*;
import static com.ynet.iplatform.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn("iplatformyuanma");
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("iplatformyuanma");
        ...
        assertEquals("iplatformyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("iplatformyuanma"))).thenReturn("java");
