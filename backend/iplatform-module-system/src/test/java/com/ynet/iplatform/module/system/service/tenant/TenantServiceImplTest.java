package com.ynet.iplatform.module.system.service.tenant;

import com.ynet.iplatform.framework.common.enums.CommonStatusEnum;
import com.ynet.iplatform.framework.common.pojo.PageResult;
import com.ynet.iplatform.framework.tenant.config.TenantProperties;
...
import com.ynet.iplatform.module.system.controller.admin.tenant.vo.tenant.TenantPageReqVO;
import com.ynet.iplatform.module.system.controller.admin.tenant.vo.tenant.TenantSaveReqVO;
import com.ynet.iplatform.module.system.dal.dataobject.permission.MenuDO;
import com.ynet.iplatform.module.system.dal.dataobject.permission.RoleDO;
import com.ynet.iplatform.module.system.dal.dataobject.tenant.TenantDO;
import com.ynet.iplatform.module.system.dal.dataobject.tenant.TenantPackageDO;
import com.ynet.iplatform.module.system.dal.mysql.tenant.TenantMapper;
import com.ynet.iplatform.module.system.enums.permission.RoleCodeEnum;
import com.ynet.iplatform.module.system.enums.permission.RoleTypeEnum;
import com.ynet.iplatform.module.system.service.permission.MenuService;
import com.ynet.iplatform.module.system.service.permission.PermissionService;
import com.ynet.iplatform.module.system.service.permission.RoleService;
import com.ynet.iplatform.module.system.service.tenant.handler.TenantInfoHandler;
import com.ynet.iplatform.module.system.service.tenant.handler.TenantMenuHandler;
...
import static com.ynet.iplatform.module.system.dal.dataobject.tenant.TenantDO.PACKAGE_ID_SYSTEM;
...
public class TenantServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateTenant() {
        ...
        when(userService.createUser(argThat(user -> {
            ...
            assertEquals("易诚", user.getNickname());
    ...
    public void testGetTenantByName() {
        // mock 数据
        TenantDO dbTenant = randomPojo(TenantDO.class, o -> o.setName("易诚"));
        tenantMapper.insert(dbTenant);// @Sql: 先插入出一条存在的数据

        // 调用
        TenantDO result = tenantService.getTenantByName("易诚");
        // 校验存在
        assertPojoEquals(result, dbTenant);
    }
