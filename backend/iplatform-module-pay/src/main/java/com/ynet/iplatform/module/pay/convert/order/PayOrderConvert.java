package com.ynet.iplatform.module.pay.convert.order;
...
public interface PayOrderConvert {
    ...
    PayOrderSubmitRespVO convert(PayOrderDO order, com.ynet.iplatform.module.pay.framework.pay.core.client.dto.order.PayOrderRespDTO respDTO);
