package com.ynet.iplatform.module.erp.controller.admin.stock.vo.in;
...
import static com.ynet.iplatform.module.erp.enums.DictTypeConstants.AUDIT_STATUS;
...
public class ErpStockInRespVO {
    ...
    @Schema(description = "供应商名称", example = "易诚")
    @ExcelProperty("供应商名称")
    ...
    @Schema(description = "创建人", example = "易诚")
    private String creator;
    @Schema(description = "创建人名称", example = "易诚")
