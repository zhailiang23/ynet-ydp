package com.ynet.iplatform.module.aicrm.enums;
...
public interface ErrorCodeConstants {
    ...
    // ========== 练习案例 1-020-200-000 ==========
    ErrorCode PRACTICE_CASE_NOT_EXISTS = new ErrorCode(1_020_200_000, "练习案例不存在");

    // ========== 练习对话 1-020-201-000 ==========
    ErrorCode PRACTICE_CONVERSATION_NOT_EXISTS = new ErrorCode(1_020_201_000, "练习对话不存在");

    // ========== 练习课程 1-020-202-000 ==========
    ErrorCode PRACTICE_COURSE_NOT_EXISTS = new ErrorCode(1_020_202_000, "练习课程不存在");
    ...
    // ========== 练习技能 1-020-205-000 ==========
    ErrorCode PRACTICE_SKILL_NOT_EXISTS = new ErrorCode(1_020_205_000, "练习技能不存在");

    // ========== 练习用户记录 1-020-206-000 ==========
    ErrorCode PRACTICE_USER_RECORD_NOT_EXISTS = new ErrorCode(1_020_206_000, "练习用户记录不存在");
