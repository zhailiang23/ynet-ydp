...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.ynet.iplatform";
    private static final String ARTIFACT_ID = "iplatform";
    private static final String PACKAGE_NAME = "com.ynet.iplatform";
    private static final String TITLE = "易诚互动管理系统";
    ...
    public static void main(String[] args) {
        ...
        String projectBaseDir = "/Users/zhailiang/Documents/code/ynet-ydp/backend";//getProjectBaseDir();
        log.info("[main][原项目路劲改地址 ({})]", projectBaseDir);

        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.ynet.iplatform";
        String artifactIdNew = "iplatform";
        String packageNameNew = "com.ynet.iplatform";
        String titleNew = "易诚互动管理系统";
