package com.ynet.iplatform.module.iot.job.device;
...
import com.ynet.iplatform.module.iot.framework.iot.config.IplatformIotProperties;
...
public class IotDeviceOfflineCheckJob implements JobHandler {
    ...
    @Resource
    private IplatformIotProperties iotProperties;
