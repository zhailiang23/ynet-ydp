package com.ynet.iplatform.module.iot.gateway.config;

import com.ynet.iplatform.module.iot.core.messagebus.core.IotMessageBus;
import com.ynet.iplatform.module.iot.gateway.protocol.emqx.IotEmqxAuthEventProtocol;
import com.ynet.iplatform.module.iot.gateway.protocol.emqx.IotEmqxDownstreamSubscriber;
import com.ynet.iplatform.module.iot.gateway.protocol.emqx.IotEmqxUpstreamProtocol;
import com.ynet.iplatform.module.iot.gateway.protocol.http.IotHttpDownstreamSubscriber;
import com.ynet.iplatform.module.iot.gateway.protocol.http.IotHttpUpstreamProtocol;
import com.ynet.iplatform.module.iot.gateway.protocol.mqtt.IotMqttDownstreamSubscriber;
import com.ynet.iplatform.module.iot.gateway.protocol.mqtt.IotMqttUpstreamProtocol;
import com.ynet.iplatform.module.iot.gateway.protocol.mqtt.manager.IotMqttConnectionManager;
import com.ynet.iplatform.module.iot.gateway.protocol.mqtt.router.IotMqttDownstreamHandler;
import com.ynet.iplatform.module.iot.gateway.protocol.tcp.IotTcpDownstreamSubscriber;
import com.ynet.iplatform.module.iot.gateway.protocol.tcp.IotTcpUpstreamProtocol;
import com.ynet.iplatform.module.iot.gateway.protocol.tcp.manager.IotTcpConnectionManager;
import com.ynet.iplatform.module.iot.gateway.service.device.IotDeviceService;
import com.ynet.iplatform.module.iot.gateway.service.device.message.IotDeviceMessageService;
...
public class IotGatewayConfiguration {
     ...
     */
    @Configuration
    @ConditionalOnProperty(prefix = "iplatform.iot.gateway.protocol.http", name = "enabled", havingValue = "true")
    @Slf4j
     ...
     */
    @Configuration
    @ConditionalOnProperty(prefix = "iplatform.iot.gateway.protocol.emqx", name = "enabled", havingValue = "true")
    @Slf4j
     ...
     */
    @Configuration
    @ConditionalOnProperty(prefix = "iplatform.iot.gateway.protocol.tcp", name = "enabled", havingValue = "true")
    @Slf4j
     ...
     */
    @Configuration
    @ConditionalOnProperty(prefix = "iplatform.iot.gateway.protocol.mqtt", name = "enabled", havingValue = "true")
    @Slf4j
