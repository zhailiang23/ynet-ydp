package com.ynet.iplatform.module.iot.core.messagebus.config;

import com.ynet.iplatform.framework.mq.redis.core.RedisMQTemplate;
import com.ynet.iplatform.framework.mq.redis.core.job.RedisPendingMessageResendJob;
import com.ynet.iplatform.framework.mq.redis.core.job.RedisStreamMessageCleanupJob;
import com.ynet.iplatform.framework.mq.redis.core.stream.AbstractRedisStreamMessage;
import com.ynet.iplatform.framework.mq.redis.core.stream.AbstractRedisStreamMessageListener;
import com.ynet.iplatform.module.iot.core.messagebus.core.IotMessageBus;
import com.ynet.iplatform.module.iot.core.messagebus.core.local.IotLocalMessageBus;
import com.ynet.iplatform.module.iot.core.messagebus.core.redis.IotRedisMessageBus;
import com.ynet.iplatform.module.iot.core.messagebus.core.rocketmq.IotRocketMQMessageBus;
import com.ynet.iplatform.module.iot.core.mq.producer.IotDeviceMessageProducer;
...
public class IotMessageBusAutoConfiguration {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "iplatform.iot.message-bus", name = "type", havingValue = "local", matchIfMissing = true)
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "iplatform.iot.message-bus", name = "type", havingValue = "rocketmq")
    ...
    /**
     * 特殊：由于 IplatformRedisMQConsumerAutoConfiguration 关于 Redis stream 的消费是动态注册，所以这里只能拷贝相关的逻辑！！！
     *
     * @see com.ynet.iplatform.framework.mq.redis.config.IplatformRedisMQConsumerAutoConfiguration
     */
    @Configuration
    @ConditionalOnProperty(prefix = "iplatform.iot.message-bus", name = "type", havingValue = "redis")
