package com.ynet.iplatform.module.infra.service.file;
...
import com.ynet.iplatform.module.infra.controller.admin.file.vo.config.FileConfigPageReqVO;
...
import com.ynet.iplatform.module.infra.dal.mysql.file.FileConfigMapper;
import com.ynet.iplatform.module.infra.framework.file.core.client.FileClient;
import com.ynet.iplatform.module.infra.framework.file.core.client.FileClientConfig;
...
import com.ynet.iplatform.module.infra.framework.file.core.enums.FileStorageEnum;
...
import static com.ynet.iplatform.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_DELETE_FAIL_MASTER;
import static com.ynet.iplatform.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_NOT_EXISTS;
...
public class FileConfigServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetFileConfigPage() {
        // mock 数据
        FileConfigDO dbFileConfig = randomFileConfigDO().setName("易诚源码")
