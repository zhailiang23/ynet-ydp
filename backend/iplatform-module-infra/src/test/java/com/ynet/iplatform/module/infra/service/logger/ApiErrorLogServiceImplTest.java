package com.ynet.iplatform.module.infra.service.logger;
...
import com.ynet.iplatform.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import com.ynet.iplatform.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import com.ynet.iplatform.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import com.ynet.iplatform.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static com.ynet.iplatform.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static com.ynet.iplatform.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("iplatform-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("iplatform-test");
