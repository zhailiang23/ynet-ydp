package com.ynet.iplatform.module.infra.controller.admin.codegen;
...
import com.ynet.iplatform.module.infra.controller.admin.codegen.vo.CodegenDetailRespVO;
import com.ynet.iplatform.module.infra.controller.admin.codegen.vo.CodegenPreviewRespVO;
...
import com.ynet.iplatform.module.infra.controller.admin.codegen.vo.table.CodegenTableRespVO;
import com.ynet.iplatform.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import com.ynet.iplatform.module.infra.convert.codegen.CodegenConvert;
...
import com.ynet.iplatform.module.infra.service.codegen.CodegenService;
...
import static com.ynet.iplatform.framework.security.core.util.SecurityFrameworkUtils.getLoginUserNickname;
import static com.ynet.iplatform.module.infra.framework.file.core.utils.FileTypeUtils.writeAttachment;
...
public class CodegenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "name", description = "表名，模糊匹配", example = "iplatform"),
            @Parameter(name = "comment", description = "描述，模糊匹配", example = "易诚")
    })
