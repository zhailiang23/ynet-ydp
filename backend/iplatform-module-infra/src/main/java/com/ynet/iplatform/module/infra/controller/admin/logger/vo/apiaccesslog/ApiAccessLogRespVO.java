package com.ynet.iplatform.module.infra.controller.admin.logger.vo.apiaccesslog;
...
public class ApiAccessLogRespVO {
    ...
    @DictFormat(com.ynet.iplatform.module.infra.enums.DictTypeConstants.OPERATE_TYPE)
    ...
    @Schema(description = "结果提示", example = "易诚源码，牛逼！")
    @ExcelProperty("结果提示")
