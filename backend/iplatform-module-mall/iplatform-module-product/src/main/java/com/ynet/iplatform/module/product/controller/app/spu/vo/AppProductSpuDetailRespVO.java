package com.ynet.iplatform.module.product.controller.app.spu.vo;

import com.ynet.iplatform.module.product.controller.app.property.vo.value.AppProductPropertyValueDetailRespVO;
...
public class AppProductSpuDetailRespVO {
    ...
    @Schema(description = "商品名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "易诚")
    private String name;
